    ...
    <div id="navbar">
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
          <Link to="/" class="navbar-brand" id="logo">
            <img alt="Aashraya" style={{ width: "40px" }} src={Logo} />
          </Link>
          <button
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item dropdown">
                ...
                >
                  <li>
                    <Link to="/assam_representative" class="dropdown-item">
                      Assam
                    </Link>
                  </li>
                  <li>
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="#">MP</a></li>
              ...
              <li class="nav-item">
                <Link to="/join_us" class="nav-link active" aria-current="page">
                  Join Us
                </Link>
              </li>
              <li class="nav-item">
